...
class _$HotelEntityImpl implements _HotelEntity {
  ...
  @override
  String toString() {
    return 'HotelEntity(hotelId: $hotelId, name: $name, destination: $destination, imageUrl: $imageUrl, ratingScore: $ratingScore, isFavorite: $isFavorite, days: $days, nights: $nights, roomName: $roomName, boarding: $boarding, adultCount: $adultCount, childrenCount: $childrenCount, flightIncluded: $flightIncluded, totalPrice: $totalPrice, pricePerPerson: $pricePerPerson)';
  }
...
abstract class _HotelEntity implements HotelEntity {
  const factory _HotelEntity(
      ...
      required final int pricePerPerson}) = _$HotelEntityImpl;
